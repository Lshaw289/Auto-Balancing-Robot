...
const int PinR2 = 10;    //  arduino  pin 6 to l298  pin IN3
...
// load and configure the DMP
 ...
 /*  use calibration program to get your own values
    ...
    mpu.setXAccelOffset(1788);//(1788); // 1688 factory default for my test chip
